...
hango({nomCom:"sticker",categorie: "Conversion", reaction: "👨🏿‍💻"},async(origineMessage,hn,commandeOptions)=>{
...
hango({nomCom:"scrop",categorie: "Conversion", reaction: "👨🏿‍💻"},async(origineMessage,hn,commandeOptions)=>{
...
mediamsg = msgRepondu.videoMessage
  ...
  var stick = await hn.downloadAndSaveMediaMessage(mediamsg)
     ...
     let stickerMess = new Sticker(stick, {
          ...
          hn.sendMessage(origineMessage, { sticker: stickerBuffer2 }, { quoted: ms });

});

hango({nomCom:"take",categorie: "Conversion", reaction: "👨🏿‍💻"},async(origineMessage,hn,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
hango({ nomCom: "write", categorie: "Conversion", reaction: "👨🏿‍💻" }, async (origineMessage, hn, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
  ...
  const image = await hn.downloadAndSaveMediaMessage(mediamsg);
...
hango({nomCom:"photo",categorie: "Conversion", reaction: "👨🏿‍💻"},async(dest,hn,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
 ...
 let mediaMess = await hn.downloadAndSaveMediaMessage(msgRepondu.stickerMessage);
...
hango({ nomCom: "trt", categorie: "Conversion", reaction: "👨🏿‍💻" }, async (dest, hn, commandeOptions) => {
...
hango({ nomCom: "url", categorie: "Conversion", reaction: "👨🏿‍💻" }, async (origineMessage, hn, commandeOptions) => {
  ...
  if (msgRepondu.videoMessage) {
      mediaPath = await hn.downloadAndSaveMediaMessage(msgRepondu.videoMessage);
  } else if (msgRepondu.imageMessage) {
      mediaPath = await hn.downloadAndSaveMediaMessage(msgRepondu.imageMessage);
  } else {
      repondre('mention a image or video');
      return;
  }
